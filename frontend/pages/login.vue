      ...
      <div class="glass-dark rounded-3xl p-8 card-hover fade-in">
        ...
        <div class="mb-6">
          <button
            ...
            class="w-full btn-hover py-3 glass border border-gray-200 rounded-2xl font-semibold flex items-center justify-center space-x-3 hover:bg-white/50 transition"
          >
            <!-- Google Icon SVG -->
